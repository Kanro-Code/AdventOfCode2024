...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `40.6µs` | `69.8µs` |
| [Day 2](./src/bin/02.rs) | `90.8µs` | `222.4µs` |
| [Day 3](./src/bin/03.rs) | `337.9µs` | `407.5µs` |
| [Day 4](./src/bin/04.rs) | `293.9µs` | `129.2µs` |
| [Day 5](./src/bin/05.rs) | `129.1µs` | `263.1µs` |
